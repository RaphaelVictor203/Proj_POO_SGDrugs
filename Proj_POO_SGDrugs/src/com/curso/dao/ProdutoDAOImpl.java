...
public class ProdutoDAOImpl implements ProdutoDAO {
	...
	public void excluirProduto(Produto p) throws DAOException {
		try {	
			...
			Alert alert = new Alert(AlertType.INFORMATION, "Exclus„o Realizada com  xito");
			alert.show();

		} catch (SQLException e) {

			Alert alert = new Alert(AlertType.ERROR, "N„o È possÌvel excluir esse Produto, pois o mesmo\n"
			+ "est· vinculado ao estoque de uma ou mais farm·cias");
			alert.show();
		}
